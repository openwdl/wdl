...
The WDL *language* has a two-number version (e.g., `2.0`).
An increase in the minor (second) version number (e.g., `2.0` to `2.1`) indicates the addition of, or non-breaking changes to, the language or standard library functions.
An increase in the major (first) version number (e.g., `1.0` to `2.0`) indicates that breaking changes have been made.

The WDL *specification* has a three-number version (e.g., `2.0.0`).
...
This branch is for version **2.0** of the [WDL language specification](https://github.com/openwdl/wdl/blob/wdl-2.0/SPEC.md).
