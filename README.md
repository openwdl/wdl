...
* For the current specification, see the repository's [default branch][github-main]. Users should use the current version unless they specifically need compatibility with `draft-1`.
