# --------------------------------------------------------------------------------------------
# This CountReadEvents WDL task was generated on 10/04/16 for use with GATK version 3.6
...
# Task Summary: Count the number of read events
# --------------------------------------------------------------------------------------------

task CountReadEvents { 
	File gatk
	File ref
	File refIndex
	File refDict
...
workflow CountReadEventsWf { 
	call CountReadEvents
}
