# --------------------------------------------------------------------------------------------
# This CheckPileup WDL task was generated on 10/04/16 for use with GATK version 3.6
...
# Task Summary: Compare GATK's internal pileup to a reference Samtools pileup
# --------------------------------------------------------------------------------------------
...
task CheckPileup { 
	...
	command {
		java -jar ${gatk} \
			...
			${default="" "-nt" + ntVal} \
			continue_after_error ${default="false" continue_after_error} \
