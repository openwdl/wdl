# --------------------------------------------------------------------------------------------
# This ReadLengthDistribution WDL task was generated on 10/04/16 for use with GATK version 3.6
...
# Task Summary: Collect read length statistics
# --------------------------------------------------------------------------------------------

task ReadLengthDistribution { 
	File gatk
	File ref
	File refIndex
	File refDict
...
workflow ReadLengthDistributionWf { 
	call ReadLengthDistribution
}
