# --------------------------------------------------------------------------------------------
# This GCContentByInterval WDL task was generated on 10/04/16 for use with GATK version 3.6
...
# Task Summary: Calculates the GC content of the reference sequence for each interval
# --------------------------------------------------------------------------------------------

task GCContentByInterval { 
	File gatk
	File ref
	File refIndex
	File refDict
...
workflow GCContentByIntervalWf { 
	call GCContentByInterval
}
